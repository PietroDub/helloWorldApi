...
{
    /// <inheritdoc />
    public partial class ControlerUpdated : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_appcontacts", x => x.CourseId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppcontactId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Appontacts", x => x.AppcontactId);
                });
